<template>
  <section class="page-termos-de-uso">
    <AppContainer class="tw-flex-col tw-gap-2">
      <AppPageTitle title="Política de Privacidade" />

      <p>
        A sua privacidade é importante para nós. É política do Escola Genesis
        respeitar a sua privacidade em relação a qualquer informação sua que
        possamos coletar no site Escola Genesis, e outros sites que possuímos e
        operamos.
      </p>
      ...
      <p>
        ...
        informação que o Escola Genesis oferece no site e com caráter
      ...
      <ul>
        ...
        <li>
          ...
          xenofóbica, kiwibet ou azar, qualquer tipo de pornografia ilegal, de
          apologia ao terrorismo ou contra os direitos humanos;
        </li>
        <li>
          C) Não causar danos aos sistemas físicos (hardwares) e lógicos
          (softwares) do Escola Genesis, de seus fornecedores ou terceiros, para
      ...
      <p>Esta política é efetiva a partir de 7 de Dezembro de 2023 15:51</p>
    </AppContainer>
  </section>
</template>
